...
<head>
  <meta charset="utf-8" />
  <title>Daftar Sesi Hari Ini | Pelatihan PEKERTI-AA</title>
        ...
        <div class="page-title-box">
          <div class="container-fluid">
            <div class="row align-items-center">
              <div class="col-md-8">
                <h4 class="page-title mb-1">Daftar Sesi</h4>
              ...
              <div class="card"> <!-- selamat datang card -->
                <div class="card-body">
                  <div class="col">
                    ...
                    <h4 class="mb-3">Daftar Sesi pada Hari Ini</h4>
                        ...
                        <tbody>
                          ...
                          @foreach ($sesi as $key => $item)
                              <tr>
                                <td>{{ $key + 1 }}</td>
                                <td>{{ $item->nama }}</td>
                                <td>{{ \Carbon\Carbon::parse($item->waktu_mulai)->format('h:i') . " WIB - " . \Carbon\Carbon::parse($item->waktu_selesai)->format('h:i') . " WIB"}}</td>
                                <td><b>{{ strtoupper($item->jenis_pelaksanaan) }}</b></td>
                                @if ($item->jenis_pelaksanaan == "luring")
                                    <td>{{ $item->tempat_pelaksanaan }}</td>
                                @else
                                    <td><a href="{{ $item->tautan_pelaksanaan }}" target="_blank">Tautan Daring Klik Disini</a></td>
                                @endif
                              </tr>
                          @endforeach
