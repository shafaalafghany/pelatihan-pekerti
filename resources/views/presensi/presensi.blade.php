...
<head>
    <meta charset="utf-8" />
    <title>Presensi | Pelatihan PEKERTI-AA</title>
                                        ...
                                        <form action="/presensi" method="POST">
                                          @csrf
                                            <div class="form-group row">
                                                <label class="col-md-2 col-form-label">Kode Presensi*</label>
                                                <div class="col-md-10">
                                                    <input class="form-control" required type="text"
                                                        name="kode_presensi" placeholder="Kode Unik Presensi">
                                                </div>
                                            </div>
