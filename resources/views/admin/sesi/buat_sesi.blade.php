...
<head>
  <meta charset="utf-8" />
  <title>Buat Sesi Baru | Pelatihan PEKERTI-AA</title>
        ...
        <div class="d-flex">
          ...
          <div class="dropdown d-inline-block">
            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
              ...
              <img class="rounded-circle header-profile-user" src="/images/default.jpg" alt="Header Avatar">
        ...
        <div class="page-title-box">
          <div class="container-fluid">
            <div class="row align-items-center">
              <div class="col-md-8">
                <h4 class="page-title mb-1">Buat Sesi Baru</h4>
                <ol class="breadcrumb m-0">
                  <li class="breadcrumb-item"><a href="/admin/dashboard/sesi">Sesi</a></li>
                  <li class="breadcrumb-item"><a href="/admin/dashboard/sesi/{{ $pelatihan->id }}">{{ $pelatihan->nama }}</a></li>
              ...
              <div class="card"> <!-- profil card -->
                <div class="card-body">
                  <div class="col">
                    ...
                    <h4 class="mb-3">Buat Sesi Baru</h4>
                    ...
                    <form action="/sesi/buat" method="POST">
                      @csrf
                      <input hidden type="text" name="id_pelatihan" value="{{ $pelatihan->id }}" required>
                      <div class="form-group row">
                        <label class="col-md-2 col-form-label">Nama Sesi*</label>
                        <div class="col-md-10">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-10">
                          <input class="form-control" type="date" name="tanggal_pelaksanaan" required>
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        <label class="col-md-2 col-form-label">Jenis Pelaksanaan*</label>
                        <div class="col-md-10">
                          <select name="jenis_pelaksanaan" class="form-control" required>
                            <option selected>Pilih Jenis Pelaksanaan</option>
                      ...
                      <div class="form-group row">
                        <label class="col-md-2 col-form-label">Tempat Pelaksanaan Luring</label>
                        <div class="col-md-10">
                      ...
                      <div class="form-group row">
                        <label class="col-md-2 col-form-label">Tautan Pelaksanaan Daring</label>
                        <div class="col-md-10">
                          <input class="form-control" type="text" name="tautan_daring">
                        </div>
                      </div>
