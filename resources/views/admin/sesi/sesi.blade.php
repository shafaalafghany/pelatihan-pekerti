...
<head>
  <meta charset="utf-8" />
  <title>Sesi PEKERTI Batch 2 | Pelatihan PEKERTI-AA</title>
                ...
                <div class="card-body">
                  <div class="col">
                    ...
                    <div class="d-flex flex-row-reverse mb-3">
                      <a href="/admin/dashboard/sesi/{{ $pelatihan->id }}/buat" class="btn btn-primary waves-effect waves-light text-light"><i class="mdi mdi-square-edit-outline"></i> Buat Baru</a>
                    </div>
