...
<head>
    <meta charset="utf-8" />
    <title>Sesi | Pelatihan PEKERTI-AA</title>
                ...
                <div class="page-title-box">
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                <h4 class="page-title mb-1">Sesi</h4>
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="/dashboard/sesi">Sesi</a></li>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="col">
                                        ...
                                        <form action="/sesi/pilih-pelatihan" method="POST">
                                          @csrf
