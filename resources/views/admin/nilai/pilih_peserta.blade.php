...
<head>
    <meta charset="utf-8" />
    <title>Pilih Peserta {{ $pelatihan->nama }} | Pelatihan PEKERTI-AA</title>
                ...
                <div class="page-title-box">
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                <h4 class="page-title mb-1">Pilih Peserta</h4>
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item"><a
                                            ...
                                            {{ $pelatihan->nama }}</a></li>
                                    <li class="breadcrumb-item active">Pilih Peserta</li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="col">
                                        ...
                                        <h4>Pilih Peserta {{ $pelatihan->nama }}</h4>
