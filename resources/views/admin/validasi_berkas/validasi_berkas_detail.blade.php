...
<head>
  <meta charset="utf-8" />
  <title>Validasi Berkas Detail | Pelatihan PEKERTI-AA</title>
            ...
            <div class="row align-items-center">
              <div class="col-md-8">
                ...
                <ol class="breadcrumb m-0">
                  ...
                  <li class="breadcrumb-item"><a href="/admin/dashboard/validasi-berkas">Validasi Berkas</a></li>
                  <li class="breadcrumb-item active">Validasi Berkas {{ $peserta->fullname }}</li>
                </ol>
              </div>
            </div>
              ...
              <div class="card"> <!-- selamat datang card -->
                <div class="card-body">
                  <div class="col">
                    ...
                    <h4 class="mb-3">Berkas {{ $peserta->fullname }}</h4>
                      ...
                      <table class="table table-bordered">
                        <tbody>
                          <tr>
                            ...
                            <td class="d-flex justify-content-center"><a href="/files/ktp/{{ $peserta->berkas_ktp }}" class="btn btn-primary waves-effect waves-light text-light">Lihat Berkas</a></td>
                          </tr>
                          <tr>
                            <td><b>SK Dosen</b></td>
                            <td class="d-flex justify-content-center"><a href="/files/sk-dosen/{{ $peserta->berkas_sk_dosen }}" class="btn btn-primary waves-effect waves-light text-light">Lihat Berkas</a></td>
                          </tr>
                          @if ($pelatihan->jenis_pelatihan == "aa")
                            <tr>
                              <td><b>SK PEKERTI</b></td>
                              <td class="d-flex justify-content-center"><a href="/files/sk-pekerti/{{ $peserta->berkas_sk_pekerti }}" class="btn btn-primary waves-effect waves-light text-light">Lihat Berkas</a></td>
                            </tr>
                          @endif
                        </tbody>
                      </table>
                    ...
                    <div class="mt-3 ml-2 row">
                      <form id="terima" action="/validasi-berkas/terima/{{ $peserta->id }}/{{ $pelatihan->id }}" method="POST">
                        @csrf
