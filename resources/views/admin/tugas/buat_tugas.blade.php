...
<head>
    <meta charset="utf-8" />
    <title>Buat Tugas Baru | Pelatihan PEKERTI-AA</title>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="col">
                                        ...
                                        <form action="/tugas/buat" method="POST" enctype="multipart/form-data">
                                          @csrf
                                            ...
                                            <div class="form-group row">
                                                <label class="col-md-2 col-form-label">Deskripsi Tugas</label>
                                                <div class="col-md-10">
                                                    <textarea class="ckeditor" name="deskripsi_tugas"></textarea>
                                                </div>
                                            </div>

                                            <div class="form-group row">
                                                <label class="col-md-2 col-form-label">Berkas Tambahan</label>
                                                <div class="col-md-10">
                                                    <label class="custom-file-label">Pilih Berkas Materi (Dapat lebih dari
                                                        1 Berkas)</label>
                                                    <input type="file" name="berkas_tambahan[]"
                                                        class="custom-file-input" multiple required>
                                                </div>
                                            </div>

                                            <div class="form-group row">
                                                <label class="col-md-2 col-form-label">Batas Pengumpulan*</label>
