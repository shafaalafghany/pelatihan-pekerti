        ...
        <div class="page-title-box">
          <div class="container-fluid">
            <div class="row align-items-center">
              <div class="col-md-8">
                <h4 class="page-title mb-1">Tugas</h4>
                ...
                <div class="card-body">
                  <div class="col">
                    ...
                    <div class="d-flex flex-row-reverse mb-3">
                      <a href="/admin/dashboard/tugas/{{ $pelatihan->id }}/buat" class="btn btn-primary waves-effect waves-light text-light"><i class="mdi mdi-square-edit-outline"></i> Buat Baru</a>
                    </div>
                        ...
                        <tbody>
                          ...
                          @foreach ($tugas as $key => $item)
                              <tr>
                                ...
                                <td>{{ $item->judul }}</td>
                                <td>{{ $item->nama }}</td>
                                <td><a href="/dashboard/admin/tugas/{{ $item->id }}/detail" class="btn btn-primary waves-effect waves-light text-light"><i class="mdi mdi-eye-circle-outline"></i></a><a class="btn btn-warning waves-effect waves-light text-light ml-3" href="#"><i class="mdi mdi-square-edit-outline"></i></a><a class="btn btn-danger waves-effect waves-light text-light ml-3" href="#" id="sa-warning"><i class="mdi mdi-trash-can-outline"></i></a></td>
                              </tr>
                          @endforeach
