        ...
        <div class="page-title-box">
          <div class="container-fluid">
            <div class="row align-items-center">
              <div class="col-md-8">
                <h4 class="page-title mb-1">Daftar Presensi</h4>
                ...
                <div class="card-body">
                  <div class="col">
                    ...
                    <div class="d-flex flex-row-reverse mb-3">
                      <a href="/admin/dashboard/presensi/{{ $pelatihan->id }}/buat" class="btn btn-primary waves-effect waves-light text-light"><i class="mdi mdi-square-edit-outline"></i> Buat Baru</a>
                    </div>
