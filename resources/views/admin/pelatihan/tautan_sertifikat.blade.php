...
<head>
    <meta charset="utf-8" />
    <title>Perbarui Tautan Sertifikat | Pelatihan PEKERTI-AA</title>
                ...
                <div class="page-title-box">
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                <h4 class="page-title mb-1">Tautan Sertifikat {{ $pelatihan->nama }} yang sudah ditandatangani</h4>
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item"><a
                                            ...
                                            {{ $pelatihan->nama }}</a></li>
                                    <li class="breadcrumb-item active">Tautan Sertifikat</li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="col">
                                        ...
                                        <form action="/pelatihan/tautan-sertifikat" method="POST">
                                            @csrf
                                            <input class="form-control" type="text" name="pelatihan"
                                                value="{{ $pelatihan->id }}" hidden>
                                            <div class="form-group row">
                                                <label class="col-md-2 col-form-label">Tautan Sertifikat yang sudah ditanda tangan*</label>
                                                <div class="col-md-10">
                                                    <input class="form-control" required type="text"
                                                        name="tautan_sertifikat" value="{{ $pelatihan->tautan_sertifikat }}">
                                                </div>
                                            </div>
