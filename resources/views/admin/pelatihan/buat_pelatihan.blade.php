...
<head>
    <meta charset="utf-8" />
    <title>Buat Pelatihan Baru | Pelatihan PEKERTI-AA</title>
                ...
                <div class="page-title-box">
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                <h4 class="page-title mb-1">Buat Pelatihan Baru</h4>
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="/admin/dashboard/pelatihan">Pelatihan</a></li>
                                    <li class="breadcrumb-item active">Buat Pelatihan Baru</li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="col">
                                        ...
                                        <h4 class="mb-3">Buat Pelatihan Baru</h4>
                                        ...
                                        <form action="/pelatihan/buat" method="POST">
                                            @csrf
                                            <div class="form-group row">
                                                <label class="col-md-2 col-form-label">Nama Pelatihan*</label>
                                                <div class="col-md-10">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-md-2 col-form-label">Jenis Pelatihan*</label>
                                                <div class="col-md-10">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-md-2 col-form-label">Tanggal Mulai
                                                    Pendaftaran*</label>
                                                <div class="col-md-10">
                                                    <input class="form-control" type="date"
                                                        name="mulai_pendaftaran" required>
                                                </div>
                                            </div>

                                            <div class="form-group row">
                                                <label class="col-md-2 col-form-label">Tanggal Batas
                                                    Pendaftaran*</label>
                                                <div class="col-md-10">
                                                    <input class="form-control" type="date"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <input class="form-control" type="date"
                                                        name="mulai_pelaksanaan" required>
                                                </div>
                                                <label class="col-md-1 col-form-label">Hingga</label>
                                                <div class="col-md-4">
                                                    <input class="form-control" type="date"
                                                        name="akhir_pelaksanaan" required>
                                                </div>
                                            </div>

                                            <div class="form-group row">
                                                <label class="col-md-2 col-form-label">Kuota Peserta*</label>
                                                <div class="col-md-10">
                                                    <input class="form-control" type="number" name="kuota_peserta"
                                                        required>
                                                </div>
                                            </div>
