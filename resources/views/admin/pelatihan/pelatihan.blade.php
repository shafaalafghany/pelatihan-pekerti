...
<head>
    <meta charset="utf-8" />
    <title>Pelatihan | Pelatihan PEKERTI-AA</title>
                ...
                <div class="page-title-box">
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                <h4 class="page-title mb-1">Daftar Pelatihan</h4>
                                ...
                                <div class="card-body">
                                    <div class="col">
                                        ...
                                        <div class="d-flex flex-row-reverse mb-3">
                                            <a href="/admin/dashboard/pelatihan/buat-pelatihan"
                                                  ...
                                                  @foreach ($pelatihan as $key => $item)
                                                      <tr>
                                                        ...
                                                        @else
                                                          <td>Tidak Aktif</td>
                                                        @endif
                                                        <td><a href="/admin/dashboard/pelatihan/{{ $item->id }}"
                                                          class="btn btn-primary waves-effect waves-light text-light">Lihat Detail</a></td>
                                                      </tr>
                                                  @endforeach
                                                </tbody>
                                            </table>
