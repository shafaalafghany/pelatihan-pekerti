...
<head>
  <meta charset="utf-8" />
  <title>Pelatihan PEKERTI Batch 1 | Pelatihan PEKERTI-AA</title>
              ...
              <div class="card"> <!-- selamat datang card -->
                <div class="card-body">
                  <div class="col">
                    ...
                    <strong>Jenis Pelatihan: </strong> {{ strtoupper($pelatihan->jenis_pelatihan) }} <br>
                    <strong>Tanggal Pelaksanaan: </strong> {{ $pelatihan->pelaksanaan }} <br>
                    <strong>Status Pelatihan: </strong> {{ $pelatihan->is_active ? "Aktif" : "Tidak Aktif" }}

                    <div class="d-flex flex-row-reverse mb-3">
                      <a href="#" class="btn btn-primary waves-effect waves-light text-light"><i class="mdi mdi-square-edit-outline"></i> Input Nilai</a>
                      <a href="#" class="btn btn-primary waves-effect waves-light text-light mr-3"><i class="mdi mdi-shape-square-plus"></i> Tambah Kolom Nilai</a>
                    </div>
