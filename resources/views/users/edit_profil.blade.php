...
<head>
  <meta charset="utf-8" />
  <title>Edit Profil | Pelatihan PEKERTI-AA</title>
        ...
        <div class="page-title-box">
          <div class="container-fluid">
            <div class="row align-items-center">
              <div class="col-md-8">
                <h4 class="page-title mb-1">Perbarui Profil</h4>
                <ol class="breadcrumb m-0">
                  <li class="breadcrumb-item"><a href="/">Beranda</a></li>
                  <li class="breadcrumb-item active">Profil {{ $user['fullname'] }}</li>
                </ol>
              </div>
            </div>
              ...
              <div class="card"> <!-- profil card -->
                <div class="card-body">
                  <div class="col">
                    ...
                    <h4 class="mb-3">Perbarui Profil</h4>
                    ...
                    <form action="/profil/perbarui-profil" method="POST" enctype="multipart/form-data">
                      @csrf
                      ...
                      <div class="form-group row">
                        ...
                        <div class="custom-file col-md">
                          ...
                          <input type="file" name="ktp" class="custom-file-input" accept="application/pdf" required>
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="custom-file col-md">
                          ...
                          <input type="file" name="sk_dosen" class="custom-file-input" accept="application/pdf" required>
                        </div>
                      </div>
                      ...
                      <div class="form-group row mt-3">
                        ...
                        <div class="custom-file col-md">
                          ...
                          <input type="file" name="foto_profil" class="custom-file-input" accept="image/png, image/jpg, image/jpeg" required>
                        </div>
                      </div>
