                                ...
                                <div class="card-body">
                                    <div class="col">
                                        ...
                                        @elseif ($user['id_pelatihan'] > 0 && $user['status_pendaftaran'] == 1)
                                            <h6 class="text-muted">Anda sedang mendaftar pada {{ $pelatihan['nama'] }},
                                                berkas anda sedang divalidasi Admin.</h6>
                                        @elseif ($user['id_pelatihan'] > 0 && $user['status_pendaftaran'] == 2)
                                            <h6 class="text-muted">Anda sedang mendaftar pada {{ $pelatihan['nama'] }},
                                                silahkan lanjutkan pendaftaran dengan melakukan pembayaran <a
                                                    href="/dashboard/pembayaran">disini</a>.</h6>
                                        @elseif ($user['id_pelatihan'] > 0 && $user['status_pendaftaran'] == 4)
                                            <h6 class="alert alert-warning"><b>Berkas anda telah ditolak, silahkan cek
                                                    kembali berkas anda.</b></h6>
                                        @elseif ($user['id_pelatihan'] > 0 && $user['status_pendaftaran'] == 5)
                                            <h6 class="alert alert-warning"><b>Anda belum membayar tagihan anda,
                                                    silahkan bayar tagihan anda.</b></h6>
                                        @else
                                            <h6 class="text-muted">Anda sedang terdaftar pada {{ $pelatihan['nama'] }}
                                            </h6>
                                        @endif
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="col">
                                        ...
                                        <div class="mb-4">
                                            <a href="/dashboard/profil/edit-profil" class="btn btn-primary">Perbarui
                                                Profil</a>
                                        </div>
                                            ...
                                            <table class="table table-bordered">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img src="{{ $user['foto_profil'] == null ? '/images/default.jpg' : '/images/foto-profil/' . $user['foto_profil'] }}"
                                                                style="max-width:100%;height:auto" width="354"
                                                                height="472"></td>
                                                    </tr>
                                                </tbody>
                                            </table>
