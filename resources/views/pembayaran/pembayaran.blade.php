...
<head>
    <meta charset="utf-8" />
    <title>Pembayaran | Pelatihan PEKERTI-AA</title>
                ...
                <div class="page-title-box">
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                <h4 class="page-title mb-1">Pembayaran</h4>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="col">
                                        ...
                                        <h6 class="mb-3">Pembayaran yang belum lunas</h6>
                                                ...
                                                <tbody>
                                                    @if ($pelatihan)
                                                        <tr>
                                                            ...
                                                            <td class="d-flex justify-content-center"><form id="bayar" method="POST" action="/pembayaran/{{ $pelatihan->id }}">@csrf
                                                                <a type="button" class="btn btn-primary waves-effect waves-light text-light" href="javascript:{}" onclick="document.getElementById('bayar').submit()">
                                                    ...
                                                    @foreach ($lunas as $key => $item)
                                                        <tr>
                                                            ...
                                                            @if ($item->status == 2)
                                                                ...
                                                                <td>-</td>
                                                            @else
                                                                <td>{{ $item->keterangan . $item->dibayar_pada}}</td>
